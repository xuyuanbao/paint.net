...
namespace PaintDotNet
{
    ...
    public static class InvariantStrings
    {
        ...
        public const string FeedbackEmail ="<-- You must specify an e-mail address for users to send feedback to." ;

        public const string CrashlogEmail = " <-- You must specify a contact e-mail address to be placed in the crash log.";

        public const string WebsiteUrl ="<-- You must specify a URL for the application's website.";
        ...
        public const string DonateUrlSetup ="<-- You must specify a destination URL for the donate button in the setup wizard." ;        
...
";
        ...
        public const string SingleInstanceMonikerName = " <-- You must specify a moniker name (only letters, no symbols, no spaces)";
    }
}
